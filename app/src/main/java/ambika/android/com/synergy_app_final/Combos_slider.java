...
public class Combos_slider extends PagerAdapter {
    private int[] image_resources = {R.drawable.combos1,R.drawable.synergybanner};
    private Context ctx;
    private LayoutInflater layoutInflater;
    public Combos_slider(Context ctx){
        this.ctx = ctx;
    }
